...
class MusicLibraryController
  ...
  def list_songs_by_artist
    #prints all songs by artist in a numbered list (alphabetized by song name)
    puts "Please enter the name of an artist:"
    input = gets.chomp
    if artist = Artist.find_by_name(input) #find artist that matches input
      #get list of songs and collect new list that is alphabetized by song name
  ...
  def list_songs_by_genre
    #prints songs by a genre in a numbered list (alphabetized by song name)
